    ...
    <?php foreach ($posts as $key => $post): ?>
        ...
        <div class="notaDetalle">
            ...
            <div class="iconos">
                ...
                <div class="derecha">                    
                    <a href="#"><?php echo image_tag('frontend/post/email', array('class' => 'mano')); ?></a>&nbsp;
                    <a href="#"><?php echo image_tag('frontend/post/pdf', array('class' => 'mano')); ?></a>&nbsp;
                    <a href="#"><?php echo image_tag('frontend/post/print', array('class' => 'mano')); ?></a>
                </div>
            </div>
