 ...
 * @method MediaType           setId()     Sets the current record's "id" value
 * @method MediaType           setName()   Sets the current record's "name" value
 * @method MediaType           setActive() Sets the current record's "active" value
 * @method MediaType           setMedias() Sets the current record's "Medias" collection
 * 
 * @package    adehr
 * @subpackage model
 ...
 */
abstract class BaseMediaType extends DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('t_media_type');
