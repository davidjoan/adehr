...
abstract class BaseMediaForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'media_type_id'     => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('MediaType'), 'add_empty' => false)),
      'name'              => new sfWidgetFormInputText(),
      'album_picasa_name' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'media_type_id'     => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('MediaType'))),
      'name'              => new sfValidatorString(array('max_length' => 100)),
      'album_picasa_name' => new sfValidatorString(array('max_length' => 100)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorAnd(array(
        new sfValidatorDoctrineUnique(array('model' => 'Media', 'column' => array('name'))),
        new sfValidatorDoctrineUnique(array('model' => 'Media', 'column' => array('slug'))),
      ))
    );
