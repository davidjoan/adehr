...
abstract class sfDoctrineRecordExt extends sfDoctrineRecord
{
   ...
   *
   * @example C:\wamp\www\adehr_1.0\web\uploads\category_images
   *
   * @param   string $field  The field name
   *
   ...
   *
   * @example /adehr_1.0/web/uploads/category_images
   *
   * @param  string $field  The field name
   *
   ...
   *
   * @example C:\wamp\www\adehr_1.0\web\uploads\category_images\example.jpg
   *
   * @param  string $field  The field name
   *
   ...
   *
   * @example /adehr_1.0/web/uploads/category_images/example.jpg
   *
   * @param  string $field  The field name
   *
