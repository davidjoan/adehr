...
class Doctrine_Template_Thumbnailable extends Doctrine_Template
{
   ...
   * 
   * @example C:\wamp\www\adehr_1.0\web\uploads\category_images\example_200px.jpg
   * 
   ...
   * @example 
   *   Given:
   *   /adehr_1.0/web/uploads/category_images/example.jpg
   *   
   *   Returns:
   *   /adehr_1.0/web/uploads/category_images/example_200px.jpg
   *   
   ...
   * 
   * @example /adehr_1.0/web/uploads/category_images/example_200px.jpg
   * 
